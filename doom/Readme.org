...
- [[#dependencies][Dependencies]]
  - [[#plaintext-spelling-check][Plaintext spelling check?]]
  - [[#lsp][LSP]]
- [[#initel][init.el]]
- [[#configel][config.el]]
...
(set-in-all-evil-states (kbd "C-r") 'isearch-backward) ; example usage
